<div class="br-logo"><a href="{{route('dashboard')}}"><span>[</span>Ecommerce <i>plus</i><span>]</span></a></div>
    <div class="br-sideleft sideleft-scrollbar">
      ...
      <label class="sidebar-label pd-x-10 mg-t-25 mg-b-20 tx-info">Ecommers Funtionality</label>
        ...
        <label class="sidebar-label pd-x-10 mg-t-25 mg-b-20 tx-info"> Location/Area Funtionality</label>
        <li class="br-menu-item">
        ...
        <label class="sidebar-label pd-x-10 mg-t-25 mg-b-20 tx-info"> Controller</label>
        <li class="br-menu-item">
          ...
          <ul class="br-menu-sub">
            ...
            <li class="sub-item"><a href="{{route('slider.manage')}}" class="sub-link  @if(Route :: currentRouteNamed('slider.manage'))active @endif">Manage All Sliders</a></li>
          </ul>
        </li>
